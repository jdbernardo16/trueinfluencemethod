        ...
        <section class="relative py-20 md:py-32 flex items-center justify-center overflow-hidden">
            ...
            <div class="relative z-10 max-w-6xl mx-auto px-6 text-center">
                <span class="inline-flex items-center gap-2 bg-[#d4b478]/10 border border-[#d4b478]/30 text-[#d4b478] text-xs font-bold tracking-[0.2em] uppercase px-4 py-2 rounded-full mb-8">
                    ...
                    <?php tim_esc_text(tim_get_field('community_hero_badge', 'The Community')); ?>
                </span>

                <h1 class="font-serif text-4xl md:text-6xl text-[#faf8f5] mb-8 leading-tight">
                    <?php tim_esc_text(tim_get_field('community_hero_heading', 'You Don\'t Do This Work Alone.')); ?>
                </h1>

                <div class="max-w-3xl mx-auto">
                    <p class="text-[#faf8f5]/80 text-lg md:text-xl leading-relaxed mb-6">
                        <?php tim_esc_text(tim_get_field('community_hero_description_1', 'The True Influence Method™️ is not just a program. It\'s a growing community of leaders committed to brave, authentic communication — people who believe that their voice is their most powerful leadership tool, and are doing the work to prove it.')); ?>
                    </p>
                    <p class="text-[#faf8f5]/80 text-lg md:text-xl leading-relaxed">
                        <?php tim_esc_text(tim_get_field('community_hero_description_2', 'When you work with Joanna, you step into that community.')); ?>
                    </p>
                </div>
                ...
                <div class="grid md:grid-cols-2 gap-8 mt-16 max-w-4xl mx-auto">
                    <?php
                    $navigation_cards = tim_get_repeater_field('community_navigation_cards', [
                        [
                            'card_title' => 'The Vault',
                            'card_description' => 'An exclusive digital library of frameworks, tools, and resources for members.',
                            'card_link' => home_url('/community/vault/'),
                        ],
                        [
                            'card_title' => 'Events & Retreats',
                            'card_description' => 'Quarterly retreat experiences designed to deepen clarity and accelerate momentum.',
                            'card_link' => home_url('/community/events/'),
                        ],
                    ]);
                        ...
                        <a href="<?php tim_esc_url($card_link); ?>"
                            ...
                            <div class="relative z-10">
                                ...
                                <h3 class="font-serif text-2xl text-[#faf8f5] mb-3 group-hover:text-[#d4b478] transition-colors">
                                    <?php tim_esc_text($card_title); ?>
                                </h3>
                                <p class="text-[#faf8f5]/60 text-sm leading-relaxed">
                                    <?php tim_esc_text($card_description); ?>
                                </p>
                            </div>
                        </a>
                    <?php endforeach; ?>
        ...
        <section class="py-24 md:py-32 bg-[#faf8f5] text-[#0f203d] relative overflow-hidden">
            ...
            <div class="max-w-4xl mx-auto px-6 relative z-10 text-center">
                <h2 class="font-serif text-3xl md:text-5xl text-[#0f203d] mb-6">
                    <?php tim_esc_text(tim_get_field('community_cta_heading', 'Ready to Join a Community of Leaders Who Speak with Courage?')); ?>
                </h2>

                <p class="text-[#0f203d]/70 text-lg leading-relaxed mb-10 max-w-2xl mx-auto">
                    <?php tim_esc_text(tim_get_field('community_cta_description', 'Take the first step toward finding your voice and leading with authentic influence.')); ?>
                </p>

                <a href="<?php tim_esc_url(tim_get_field('community_cta_button_link', home_url('/apply/'))); ?>"
                    ...
                    <?php tim_esc_text(tim_get_field('community_cta_button_text', 'Apply to Work With Joanna')); ?>
