    ...
    <div class="max-w-7xl mx-auto px-6">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            ...
            <div class="md:col-span-1">
                <?php
                $footer_logo = tim_get_image_field('footer_logo', '', 'True Influence Method');
                if (empty($footer_logo['url'])) {
                    $footer_logo['url'] = get_template_directory_uri() . '/assets/images/icononly_transparent_nobuffer.png';
                }
                $footer_name         = tim_get_field('footer_name', 'Joanna Horton McPherson');
                $footer_tagline      = tim_get_field('footer_tagline', 'Private Advisor · Master Coach');
                $footer_brand_label  = tim_get_field('footer_brand_label', 'True Influence Method™');
                ?>
                <div class="mb-4">
                ...
                <!-- Social Links -->
                <?php
                $footer_email     = tim_get_field('footer_email', 'joanna@trueinfluencemethod.com');
                $footer_instagram = tim_get_field('footer_instagram_url', 'https://instagram.com/joannahortonmcpherson');
                $footer_website   = tim_get_field('footer_website_url', 'https://joannahortonmcpherson.com');
                $footer_linkedin  = tim_get_field('footer_linkedin_url', '');
                $footer_youtube   = tim_get_field('footer_youtube_url', '');
                $footer_facebook  = tim_get_field('footer_facebook_url', '');
                ?>
            ...
            <div>
                <?php
                $explore_heading = tim_get_field('footer_explore_heading', 'Explore');
            ...
            <div>
                <?php
                $programs_heading = tim_get_field('footer_programs_heading', 'Programs');
            ...
            <div>
                <?php
                $newsletter_heading   = tim_get_field('footer_newsletter_heading', 'Stay Connected');
                $newsletter_desc      = tim_get_field('footer_newsletter_description', 'Weekly insights on authentic influence.');
                $newsletter_placeholder = tim_get_field('footer_newsletter_placeholder', 'your@email.com');
                $newsletter_btn_text  = tim_get_field('footer_newsletter_button_text', 'Subscribe');
                ?>
        ...
        <!-- Quote & Legal -->
        <?php
        $footer_quote_text   = tim_get_field('footer_quote_text', '"Traveler, there is no path. The path is made by walking."');
        $footer_quote_attr   = tim_get_field('footer_quote_attribution', '— Antonio Machado');
        $footer_copyright    = tim_get_field('footer_copyright', '© [year] Joanna Horton McPherson · All rights reserved.');
        $footer_privacy_url  = tim_get_field('footer_privacy_url', home_url('/privacy'));
        $footer_terms_url    = tim_get_field('footer_terms_url', home_url('/terms'));
        $footer_privacy_label = tim_get_field('footer_privacy_label', 'Privacy');
        $footer_terms_label  = tim_get_field('footer_terms_label', 'Terms');
