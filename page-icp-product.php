...
<body <?php body_class(); ?>>
    ...
    const productData = {
        breakthrough: {
            ...
            for: ['The Speaker — perfect starting point', 'The Authority — quick clarity before a larger program', 'The Legacy — not recommended (needs deeper work)'],
        ...
        '4session': {
            ...
            for: ['The Speaker — ideal for deep foundational work', 'The Authority — good if you want private refinement', 'The Legacy — not recommended'],
            icpFit: { speaker: 'good', authority: 'neutral', legacy: 'bad' },
            icpGood: 'Best for: The Speaker',
        ...
        phase1: {
            ...
            for: ['The Speaker — the core program for you', 'The Authority — only if you lack foundational clarity', 'The Legacy — not recommended'],
            icpFit: { speaker: 'good', authority: 'neutral', legacy: 'bad' },
            icpGood: 'Best for: The Speaker',
        ...
        phase2: {
            ...
            for: ['The Speaker — not yet (complete Phase 1 first)', 'The Authority — the ideal program for you', 'The Legacy — not recommended (you need legacy-level work)'],
        ...
        phase3: {
            ...
            for: ['The Speaker — not yet', 'The Authority — the advanced program for you', 'The Legacy — not recommended (you need legacy-level work)'],
            icpFit: { speaker: 'bad', authority: 'good', legacy: 'bad' },
            icpGood: 'Best for: The Authority',
        ...
        phase4: {
            ...
            for: ['The Speaker — not applicable', 'The Authority — only with prior Phases 1-3', 'The Legacy — the right level for you'],
        ...
        phase5: {
            ...
            for: ['The Speaker — not applicable', 'The Authority — not yet', 'The Legacy — the ultimate program for you'],
        ...
        private: {
            ...
            for: ['The Speaker — not applicable', 'The Authority — if you need private, advanced work', 'The Legacy — the recommended starting point'],
            icpFit: { speaker: 'bad', authority: 'neutral', legacy: 'good' },
            icpGood: 'Best for: The Legacy',
