 ...
 * Description: Speaking Tips landing page template
 *
 * @package tim-wordpress
 */

// Get quick tips (short, actionable tips)
$quick_tips = new WP_Query([
    'post_type' => 'tips',
    'posts_per_page' => 6,
    'post_status' => 'publish',
    'orderby' => 'date',
...
$tips = new WP_Query([
    ...
    'orderby' => 'date',
    'order' => 'DESC',
    'post__not_in' => wp_list_pluck($quick_tips->posts, 'ID'),
]);
...
<body <?php body_class(); ?>>
    ...
    <div class="overflow-x-hidden">
            ...
            <div class="max-w-5xl mx-auto px-6 relative z-10 text-center">
                <div class="mb-8">
                    <span class="inline-flex items-center gap-2 bg-[#d4b478]/10 border border-[#d4b478]/30 text-[#d4b478] text-xs font-bold tracking-[0.2em] uppercase px-4 py-2 rounded-full">
                        ...
                        <?php echo esc_html(tim_get_field('tips_hero_badge', 'Quick Wins')); ?>
                    </span>
                </div>
                ...
                $cta_url = $cta_link ? get_permalink($cta_link) : '#tips-grid';
                ?>
                <a href="<?php echo esc_url($cta_url); ?>"
                    ...
                    <?php echo esc_html(tim_get_field('tips_hero_cta_text', 'Get Started')); ?>
                ...
                <div class="max-w-7xl mx-auto px-6 relative z-10">
                    <div class="text-center mb-16">
                        <span class="inline-flex items-center gap-2 bg-[#d4b478]/10 border border-[#d4b478]/30 text-[#d4b478] text-xs font-bold tracking-[0.2em] uppercase px-4 py-2 rounded-full mb-6">
                            <?php echo esc_html(tim_get_field('tips_quick_badge', 'Quick Wins')); ?>
                        </span>
                    ...
                    <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                        <?php while ($quick_tips->have_posts()) : $quick_tips->the_post(); ?>
        ...
        <section id="tips-grid" class="py-20 md:py-32 bg-[#0f203d] text-[#faf8f5] relative overflow-hidden">
            <div class="absolute inset-0 bg-[radial-gradient(circle_at_center,_var(--tw-gradient-stops))] from-[#d4b478]/5 to-transparent"></div>

            <div class="max-w-7xl mx-auto px-6 relative z-10">
                <div class="text-center mb-16">
                    <span class="inline-flex items-center gap-2 bg-[#d4b478]/10 border border-[#d4b478]/30 text-[#d4b478] text-xs font-bold tracking-[0.2em] uppercase px-4 py-2 rounded-full mb-6">
                        <?php echo esc_html(tim_get_field('tips_grid_badge', 'All Tips')); ?>
                    </span>
